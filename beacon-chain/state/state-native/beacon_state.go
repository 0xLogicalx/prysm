...
type BeaconState struct {
	...
	// Gloas fields
	executionPayloadHeader       *ethpb.ExecutionPayloadHeaderGloas
...
type beaconStateMarshalable struct {
	...
	ExecutionPayloadHeader              *ethpb.ExecutionPayloadHeaderGloas      `json:"execution_payload_header" yaml:"execution_payload_header"`
