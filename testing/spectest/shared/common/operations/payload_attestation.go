...
func RunPayloadAttestationTest(t *testing.T, config string, fork string, block blockWithSSZObject, sszToState SSZToState) {
	runPayloadAttestationTest(t, config, fork, "payload_attestation", block, sszToState, func(ctx context.Context, s state.BeaconState, att *eth.PayloadAttestation) (state.BeaconState, error) {
...
func runPayloadAttestationTest(t *testing.T, config string, fork string, objName string, _ blockWithSSZObject, sszToState SSZToState, operationFn PayloadAttestationOperation) {
...
func createMockBlockBodyWithPayloadAttestation(att *eth.PayloadAttestation) (*eth.BeaconBlockBodyGloas, error) {
	body := &eth.BeaconBlockBodyGloas{
		...
		SignedExecutionPayloadHeader: &eth.SignedExecutionPayloadHeader{},
	}
	return body, nil
}
