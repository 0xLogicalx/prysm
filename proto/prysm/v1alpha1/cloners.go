...
// copySignedExecutionPayloadHeader copies the provided signed execution payload header.
func copySignedExecutionPayloadHeader(header *SignedExecutionPayloadHeader) *SignedExecutionPayloadHeader {
	if header == nil {
		return nil
	}
	copied := &SignedExecutionPayloadHeader{
		Signature: bytesutil.SafeCopyBytes(header.Signature),
	}
	if header.Message != nil {
		copied.Message = &ExecutionPayloadHeaderGloas{
...
func copyBeaconBlockBodyGloas(body *BeaconBlockBodyGloas) *BeaconBlockBodyGloas {
	...
	copied.SignedExecutionPayloadHeader = copySignedExecutionPayloadHeader(body.SignedExecutionPayloadHeader)
